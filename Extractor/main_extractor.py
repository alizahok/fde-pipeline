...
class MainExtractor:
    ...
    def setup_extractors(self):
        ...
        self.ensure_schema_exists("landing")  # ✅ Ensure schema exists
    ...
    def ensure_schema_exists(self, schema_name="landing"):
    ...
    def truncate_table(self, table_name, schema="landing"):
        """Truncate the specified table in the given schema if it exists"""
        ...
        try:
            with engine.connect() as conn:
                ...
                if result.scalar():
                    ...
                    logger.warning(f"Table {schema}.{table_name} does not exist — skipping truncate.")
